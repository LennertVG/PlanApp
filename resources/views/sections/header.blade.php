...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    {{-- <body class="antialiased">
        ...
        <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-400 selection:bg-red-500 selection:text-white">
            @if (Route::has('login'))
